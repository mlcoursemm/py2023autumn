...
* Девятое занятие состоится в четверг, 23 ноября, в 18:30 онлайн в Жoom
* Деcятое занятие состоится в четверг, 30 ноября, в 18:30 онлайн в Жoom
...
| 09            | 23.11.2023    | Параллелизация в Python. HTTP запросы. | Параллелизация в Python. HTTP запросы. | Корвяков В.П.|
| 10            | 30.11.2023    | PIL, Scikit-Image, OpenCV |  | Иванюта А. С.|
